%IDP Assignment sample test code
...
for j=1:5500                                       
    if b((2*j)-1)==0 && b(2*j)==0
        x((2*j)-1)=1;
        x(2*j) = 0;
    elseif b((2*j)-1)==0 && b(2*j)==1                                              
        x((2*j)-1)=0;
        x(2*j) = 1;
    elseif b((2*j)-1)==1 && b(2*j)==1                                              
        x((2*j)-1)=-1;
        x(2*j) = 0;
    elseif b((2*j)-1)==1 && b(2*j)==0                                              
        x((2*j)-1)=0;
        x(2*j) = -1;
...
s1 = 1*cos(2*pi*fc*Ts*(0:(length(s)-1))) + 0*sin(2*pi*fc*Ts*(0:(length(s)-1)));
s2 = 0*cos(2*pi*fc*Ts*(0:(length(s)-1))) + 1*sin(2*pi*fc*Ts*(0:(length(s)-1)));
s3 = -1*cos(2*pi*fc*Ts*(0:(length(s)-1))) + 0*sin(2*pi*fc*Ts*(0:(length(s)-1)));
s4 = 0*cos(2*pi*fc*Ts*(0:(length(s)-1))) + -1*sin(2*pi*fc*Ts*(0:(length(s)-1)));

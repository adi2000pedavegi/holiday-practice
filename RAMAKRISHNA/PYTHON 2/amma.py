...
input_frame=Frame(aditya,width=312,height=47,bd=0,highlightcolor='black',highlightbackground='black',highlightthickness=1)
...
btns_frame=Frame(aditya,width=312,height=290.5,bg='grey')
btns_frame.pack()

clear=Button(btns_frame,width=21,height=3,fg='black',text='C',bd=0,bg='#eee',cursor='hand2',command=lambda:btn_clear()).grid(row=0,column=0,columnspan=2,padx=1,pady=1)
remainder=Button(btns_frame,width=10,height=3,fg='black',text='%',bd=0,bg='#eee',cursor='hand2',command=lambda:btn_click('%')).grid(row=0,column=2,padx=1,pady=1)
...
zero=Button(btns_frame,width=10,height=3,fg='black',text='0',bd=0,bg='#fff',cursor='hand2',command=lambda:btn_click(0)).grid(row=4,column=0,padx=1,pady=1)
deciamal=Button(btns_frame,width=10,height=3,fg='black',text='.',bd=0,bg='#eee',cursor='hand2',command=lambda:btn_click('.')).grid(row=4,column=1,padx=1,pady=1)
equal=Button(btns_frame,width=10,height=3,fg='black',text='=',bd=0,bg='#eee',cursor='hand2',command=lambda:btn_equal()).grid(row=4,column=2,padx=1,pady=1)
power=Button(btns_frame,width=10,height=3,fg='black',text='**',bd=0,bg='#eee',cursor='hand2',command=lambda:btn_click('**')).grid(row=4,column=3,padx=1,pady=1)
aditya.mainloop()

...
input_field=Entry(input_frame,font=('arial',18,'bold'),textvariable=input_text,bd=0,bg='#eee',width=50,justify='right')
...
clear=Button(btns_frame,width=10,height=3,fg='black',text='C',bd=0,bg='#eee',cursor='hand2',command=lambda:btn_clear()).grid(row=0,column=0,padx=1,pady=1)
remainder=Button(btns_frame,width=10,height=3,fg='black',text='%',bd=0,bg='#eee',cursor='hand2',command=lambda:btn_click('%')).grid(row=0,column=1,padx=1,pady=1)
power=Button(btns_frame,width=10,height=3,fg='black',text='**',bd=0,bg='#eee',cursor='hand2',command=lambda:btn_click('**')).grid(row=0,column=2,padx=1,pady=1)
...
binaryxor=Button(btns_frame,width=10,height=3,fg='black',text='^',bd=0,bg='#eee',cursor='hand2',command=lambda:btn_click('^')).grid(row=4,column=1,padx=1,pady=1)
